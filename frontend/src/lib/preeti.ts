 ...
 *
 * Ported from webapp/static/preeti.js (the Flask document digitizer) /
 * frontend/src/lib/preeti.js (the ml-branch document digitizer app).
 */
...
const POST_RULES: [string, string][] = [
...
const UTOP: Record<string, string> = {
...
function mapCluster(uni: string): string {
  let out = "";
